/*
 * Script Name: Custom Fake Script Generator
 * Version: v1.0.0
 * Last Updated: 2024-06-02
 * Author: YourName
 * Author URL: YourWebsiteURL
 * Author Contact: YourContactInfo
 * Approved: N/A
 * Approved Date: N/A
 * Mod: N/A
 */
...
var scriptConfig = {
    scriptData: {
        prefix: 'customFakeScriptGenerator',
        name: 'Custom Fake Script Generator',
        version: 'v1.0.0',
        author: 'YourName',
        authorUrl: 'YourWebsiteURL',
...
$.getScript(
    `https://your-domain.com/path/to/twSDK.js?url=${document.currentScript.src}`,
    async function () {
        // Initialize Library
                ...
                if (coordinatesFillMode === 'manual') {
                    ...
                    if (coordinatesArray.length) {
                        ...
                        const scriptNew = `javascript:var config=${JSON.stringify(
                            config
                        )};$.ajax({type: 'GET',url: 'https://your-domain.com/path/to/fakeScriptClient.js',dataType: 'script',cache: true});`;
